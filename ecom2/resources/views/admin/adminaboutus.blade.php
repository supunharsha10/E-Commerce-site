            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted"> so many ecommerce brands out there offering similar or identical products, customers have increasing expectations. A brand with a strong 'why' provides consumers something to believe in. A by-product of belief is loyalty from customers, which gives you the competitive edge.</p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3"
                                ...
                                <img class="img-fluid" src="../adminaboutus/assets/img/portfolio/03-thumbnail.jpg" alt=""
                            /></a>
                            <div class="portfolio-caption">
